...
# Поделим 30 лет на 3 периода по 10 лет.
# Для фильмов из каждого диапазона посчитаем средние рейтинг, длину, стоимость съёмок одной минуты и сборы.
# Допишите код, чтобы создать таблицу с этой информацией и вывести её на экран.
...
for begin_end in years:
    ...
    mean_ppm = column_mean(filtered_data, 7)
    mean_gross = column_mean(filtered_data, 6)
